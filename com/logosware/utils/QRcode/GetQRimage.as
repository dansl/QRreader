...
package com.logosware.utils.QRcode
{
	...
	public class GetQRimage extends EventDispatcher
	{
		 ...
		 **/
		public function GetQRimage(source:DisplayObject, cutRect:Rectangle = null, debug:Boolean = false, subtract:Boolean = false)
		{
			_imageSource = source;
			detecter = new QRCodeDetecter(_imageSource, cutRect, debug, subtract);
		}
